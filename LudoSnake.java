    ...
    public Pane createContain() {
        ...
        player1Button.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                if (gameStart) {
                    if (playerOneTurn) {
                        getDiceValue();
                        randResult.setText("Player One - " + String.valueOf(diceValue));
                        //moving the player
        ...
        player2Button.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                if (gameStart) {
                    if (playerTwoTurn) {
                        getDiceValue();
                        randResult.setText("Player Two - " + String.valueOf(diceValue));
                        //moving the player
        ...
        gameButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                gameStart=true;
                gameButton.setText("GameGoing");
            }
        });

        //img=new Image("C:\\Users\\Dhiren\\IdeaProjects\\LudoSnake\\src\\SnakeLadderNo.jpg");
        Image img = new Image("C:\\Users\\Dhiren\\IdeaProjects\\LudoSnake\\src\\SnakeLadderYes.jpg");
